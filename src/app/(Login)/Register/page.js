...
const RegisterFormComponent = () => {
    ...
    return (
        <div className="flex flex-col my-4">
            ...
            >
                <TextField label="First Name" variant="outlined" className="rounded-xl" />
                <TextField label="Last Name" variant="outlined" className="rounded-xl" />
...
export default function Register(props) {
    return (
        <div className="flex flex-col w-full max-w-[400px] mx-auto p-8 rounded-xl border border-gray-300">
            <img
                src="img/logo/sphere/logo.svg"
                className="w-1/2"
            />
            <div className="my-4">
                <h4 className="text-xl">Sign up for your free account</h4>
                <p className="text-sm text-gray-400">Already registered? <Link href="/Login" className="text-black underline hover:cursor-pointer">Click here to login</Link></p>
            </div>
