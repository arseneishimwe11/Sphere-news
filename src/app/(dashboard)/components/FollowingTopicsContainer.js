...
import CategoriesContainer from "./FollowingCategoriesContainer";
...
const FollowingTopicsContainer = () => {
    ...
    const placeholdertext = "Tags & Topics";
...
export default FollowingTopicsContainer;