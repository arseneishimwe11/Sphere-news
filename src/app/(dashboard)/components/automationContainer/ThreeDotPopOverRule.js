...
const ThreeDotPopover = ({ duplicateRuleData, deleteRuleData, index }) => {
        ...
        <>
            ...
            >
                <div className='flex flex-col items-start rounded-[20px] m-[7px]'>
                    ...
                    <Button onClick={() => { handleClose(); duplicateRuleData(index); }} className='flex flex-row gap-[5px]' sx={{ textTransform: 'none', width: "100%", justifyContent: "start" }}>
                        <ContentCopyOutlinedIcon sx={{ color: "black" }} />
